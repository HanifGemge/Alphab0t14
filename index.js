/*
	...
	あ JASA RUN HEROKU BISA PC wa.me/6281529467548 BIAR BOT NYA GAK TERLALU DELAY
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`6281529467548@s.whatsapp.net`, `918156874290@s.whatsapp.net` , `62857101331033@s.whatsapp.net`]
...
const bugtrol = { 
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"message": `${creator}`,
						"orderTitle": `${creator}`,
						"sellerJid": "6281529467548@s.whatsapp.net",
...
let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`))  
let fil = vote.map(v => v.participant)
let id_vote = sender ? sender : '6281529467548@s.whatsapp.net'
if(fil.includes(id_vote)) {
